...
import com.android.server.hertzify.HertzifyDeviceConfigService;
...
public final class SystemServer implements Dumpable {
    ...
    private void startOtherServices(@NonNull TimingsTraceAndSlog t) {
        ...
        if (mFactoryTestMode == FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            // HertzifyDeviceConfigService
            t.traceBegin("StartHertzifyDeviceConfigService");
            mSystemServiceManager.startService(HertzifyDeviceConfigService.class);
            t.traceEnd();
